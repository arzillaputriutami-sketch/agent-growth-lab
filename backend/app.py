"""FastAPI boundary for Growth Experiment Lab."""
...
if FastAPI:
    ...
    def list_experiments():
        return {"status": "ok", "endpoint": "/api/experiments", "project": PROJECT_NAME, "demo": True}

    @app.get("/api/experiments/{id}/results")
    def experiment_results():
        return {"status": "ok", "endpoint": "/api/experiments/{id}/results", "project": PROJECT_NAME, "demo": True}

    @app.get("/api/metrics")
    def growth_metrics():
        return {"status": "ok", "endpoint": "/api/metrics", "project": PROJECT_NAME, "demo": True}
else:
    app = None
