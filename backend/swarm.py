"""Agent Growth Lab multi-agent reasoning core.
...
PROJECT_NAME = 'Agent Growth Lab'
DOMAIN = 'Web3 growth automation'
AUDIENCE = 'growth teams and founders'
AGENT_ROLES = ['Audience Segmenter', 'Campaign Hypothesis Agent', 'Funnel Friction Analyst', 'Creative Variant Scorer', 'Growth Ops Planner']
SIGNALS = ['activation_rate', 'wallet_connect_dropoff', 'referral_k_factor', 'campaign_cac', 'retention_d7']
SCENARIOS = ['testnet campaign launch', 'creator referral program', 'waitlist conversion audit']
